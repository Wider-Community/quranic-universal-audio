...
DECLARED = {
    ...
    (114, 80200): {
        "families": {
            ...
            "fix": ("at_most", 557),
            "residue": ("at_most", 198),
            "cell_owner": ("exact", 44119),
            "cell_greyed": ("exact", 985),
            "cell_share": ("exact", 15537),
            "cell_cut": ("exact", 24504),
        },
        "members": {
            "the waw carrying a dagger alif is sounded": ("at_most", 184),
            "a carrier letter legacy sounded is greyed": ("at_most", 3),
    ...
    (114, 84998): {
        "families": {
            ...
            "fix": ("at_most", 569),
            "residue": ("at_most", 222),
            "cell_owner": ("exact", 46436),
            "cell_greyed": ("exact", 1127),
            "cell_share": ("exact", 16549),
