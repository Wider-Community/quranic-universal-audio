...
``scripts/lib/timestamps_reshape.py`` (and the local-dir dry-run CLI in
...
# Allow ``python scripts/jobs/reshape_timestamps_bucket.py`` from the repo root.
sys.path.insert(0, str(Path(__file__).resolve().parents[2]))

from scripts.lib.timestamps_reshape import classify_shard, reshape_shard  # noqa: E402
from scripts.lib.timestamps_shards import gzip_shard  # noqa: E402
