...
- docs/hf_dataset_card.md (badge counts: reciters + riwayat)
...
def collect_readme_badges():
    """Parse badge counts from README.md and docs/hf_dataset_card.md."""
    result = {}
    for key, path in [("readme", REPO_ROOT / "README.md"), ("dataset", REPO_ROOT / "docs" / "hf_dataset_card.md")]:
...
def audit(disk, badges):
    ...
    for key, label in [("readme", "README.md"), ("dataset", "docs/hf_dataset_card.md")]:
        b = badges[key]
...
def apply_fixes(disk):
    ...
    # Update docs/hf_dataset_card.md badges too
    dataset_readme_path = REPO_ROOT / "docs" / "hf_dataset_card.md"
    if dataset_readme_path.exists():
        ...
        if ds_text != original:
            ...
            print(f"  Updated docs/hf_dataset_card.md badges")
