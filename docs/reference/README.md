...
| [shards.md](shards.md) | **The timestamp shard reference.** Native v12 connected readings, schema-2 phonemizer documents, timing sidecars, identity ownership, generation, strict audit, and atomic cutover. |
