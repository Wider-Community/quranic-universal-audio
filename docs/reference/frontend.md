...
| `domain.ts` (codegen sources under `qua_shared/schemas/`) | `Segment`, `EditOp`, `PeakBucket`, `HistoryBatch`, `PhonemeInterval`, … (FE types autogenerated; never hand-edit `lib/types/generated/`) |
