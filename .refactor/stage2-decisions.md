...
| S2-D03 | `validators/` package handling | Vendor into inspector/, feature-flag, leave as sibling | **Vendor** | USER | ACTIVE | Source SHA to be recorded in this log at Wave 2a; sibling package dependency removed |
