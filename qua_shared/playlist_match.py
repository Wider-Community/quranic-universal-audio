...
ENGLISH_ALIASES: dict[str, str] = {
    ...
    "mujadalah": "Al-Mujaadila",
    "mujadala": "Al-Mujaadila",
    "hashr": "Al-Hashr",
    "mumtahanah": "Al-Mumtahana",
    "mumtahana": "Al-Mumtahana",
    "mumtahinah": "Al-Mumtahana",
    "saff": "As-Saff",
    "jumuah": "Al-Jumua",
    "jumu'ah": "Al-Jumua",
    "jumua": "Al-Jumua",
...
def validate_chapter_map(
    ...
    * **Unresolved title (WARNING):** title couldn't be matched — needs a human
    ...
    for i, e in enumerate(entries):
        ...
        if num is None:
            r.warnings.append(
                f"entry[{i}] chapter {ch}: title not resolvable {title!r} — eyeball it"
            )
