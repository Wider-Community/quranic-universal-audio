...
# VBR/CBR detection results, one file across all reciters. Generated by
# scripts/probe_audio_meta.py. Inspector reads this at chapter-load time to
# decide whether to route playback through the segment-clip endpoint
# (VBR-without-Xing-header MP3s mis-seek under HTML5 <audio>.currentTime).
AUDIO_META_PATH = DATA_DIR / ".audio_meta.json"
