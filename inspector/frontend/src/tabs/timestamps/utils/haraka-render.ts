...
const BY_CODEPOINT: Record<string, HarakaRender> = {
    ...
    '6e2': { scale: 0.8, shiftEm: -0.035, raiseEm: -0.275 }, // mini-meem above (iqlab ḍamma/fatḥa, U+06E2)
    '6ed': { scale: 0.81, shiftEm: -0.09, raiseEm: -0.212 }, // mini-meem below (iqlab kasra, U+06ED)
};
