...
describe.skipIf(!stale)('filterStaleIssues', () => {
  it('drops items whose uid is not in current state', xfail('phase-6', () => {
  ...
  it('keeps items whose uid is in current state', xfail('phase-6', () => {
  ...
  it('keeps legacy issues (no uid) for seg_index resolution', xfail('phase-6', () => {
