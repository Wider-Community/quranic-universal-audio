 ...
 * This is the entry point: main.js imports './timestamps/index.js'.
 *
...
import { setupCanvas, decodeWaveform, cacheWaveformSnapshot, handleCanvasClick } from './waveform.js';
import { buildUnifiedDisplay, buildPhonemeLabels } from './unified-display.js';
import { switchView, switchGranularity, rebuildAnimationView } from './animation.js';
import { _loadAudioAndPlay, navigateVerse, toggleAutoMode, startAnimation, stopAnimation, updateDisplay } from './playback.js';
import { handleKeydown } from './keyboard.js';
import { renderTsValidationPanel } from './validation.js';
